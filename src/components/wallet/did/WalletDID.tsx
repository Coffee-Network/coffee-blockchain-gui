...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@coffee/core';
import {
...
import { mojo_to_coffee_string } from '../../../util/coffee';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_coffee_string(props.balance)} TXCH
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'coffee_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'coffee_addr://') {
