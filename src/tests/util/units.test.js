...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of coffee', () => {
      const result = units.getUnit('coffee');
    ...
    it('gets unit of coffee using alias', () => {
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('coffee', 9);

      const result = units.getUnit('coffee');

      expect(result).toEqual(9);

      units.setUnit('coffee', 1);
    });
  });
  describe('#setDisplay', () => {
