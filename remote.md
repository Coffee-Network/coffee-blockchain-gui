...
````bash
~/.coffee/<currentversion>/config/ssl/daemon/private_daemon.crt
~/.coffee/<currentversion>/config/ssl/daemon/private_daemon.key
````
...
````bash
~/.coffee/<currentversion>/config/ssl/ui/
~/.coffee/<currentversion>/config/ssl/ui/
````
